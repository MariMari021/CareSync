...
export function Dinheiro({navigation}) {
                ...
                <View style={styles.container} onLayout={onLayoutRootView}>
                    ...
                    <View style={styles.header}>
                        <Text style={[styles.titulo, { color: '#FDAA5D' }]}>Doação de
                            <Text style={{ color: '#4AB7B6' }}> dinheiro</Text>
                        </Text>
                    ...
                    <View style={styles.ongs}>
                        <TouchableOpacity onPress={() => Linking.openURL('https://www.amigosdobem.org')} >
                            <Image style={styles.caixaOng} source={require('./assets/din1.png')} />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => Linking.openURL('https://www.tamar.org.br')}>
                            <Image style={styles.caixaOng} source={require('./assets/din2.png')} />
                        </TouchableOpacity>
                        <TouchableOpacity  onPress={() => Linking.openURL('https://www.greenpeace.org/brasil')}>
                            <Image style={styles.caixaOng} source={require('./assets/din3.png')} />
                        </TouchableOpacity>
                        <TouchableOpacity  onPress={() => Linking.openURL('https://www.vivaedeixeviver.org.br')}>
                            <Image style={styles.caixaOng} source={require('./assets/din4.png')} />
                        </TouchableOpacity>
