...
export function Alimentos({ navigation }) {
            ...
            <View style={styles.container} onLayout={onLayoutRootView}>
                ...
                <View style={styles.header}>
                    <Text style={[styles.titulo, { color: '#FDAA5D' }]}>Doação de
                        <Text style={{ color: '#4AB7B6' }}> alimentos</Text>
                    </Text>
                ...
                <View style={styles.ongs}>
                    <TouchableOpacity onPress={() => Linking.openURL('https://www.acaodacidadania.org.br')}>
                        <Image style={styles.caixaOng} source={require('./assets/ali1.png')} />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => Linking.openURL('https://www.amigosdobem.org')}>
                        <Image style={styles.caixaOng} source={require('./assets/ali2.png')} />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => Linking.openURL('https://www.institutostophunger.org')}>
                        <Image style={styles.caixaOng} source={require('./assets/ali3.png')} />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => Linking.openURL('https://www.cruzvermelha.org.br')}>
                        <Image style={styles.caixaOng} source={require('./assets/ali4.png')} />
                    </TouchableOpacity>
